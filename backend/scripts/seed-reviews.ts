...
const SEED: SeedRow[] = [
  {
    authorName: 'Élodie M.',
    authorLocation: 'Annecy, Haute-Savoie',
  ...
  {
    authorName: 'Lucie B.',
    authorLocation: 'Chambéry, Savoie',
    tyreName: 'POWER ALL SEASON',
    kmAtReview: 1920,
    totalKm: 5760,
    rating: 5,
  ...
  },
  {
    ...
    rating: 5,
    comment:
      'Mon pneu de référence depuis 2 saisons. Polyvalence remarquable, rien à redire.',
  ...
  },
  {
    ...
    rating: 5,
    comment:
      'La résistance au roulement est vraiment faible, on gagne facilement 1–2 km/h sur le plat. Excellent en conditions sèches.',
  ...
  {
    authorName: 'Sébastien R.',
    authorLocation: 'Bordeaux, Gironde',
    tyreName: 'POWER ROAD',
    kmAtReview: 2600,
    totalKm: 6200,
    rating: 4,
    comment:
      "Pneu très performant en conditions sèches. Un peu moins à l'aise sous la pluie mais reste très utilisable.",
  ...
  {
    authorName: 'Aurélie F.',
    authorLocation: 'Grenoble, Isère',
    tyreName: 'PRO5',
    kmAtReview: 5200,
    totalKm: 11800,
    rating: 5,
    comment:
      "Impressionnant en termes de durabilité. Encore utilisable après 5 000 km, c'est incroyable.",
